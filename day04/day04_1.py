...
def is_A_fully_overlapping_B(a: List[int], b: List[int]) -> bool:
...
def check_for_overlap(assignment_pair: str) -> bool:
    ...
    return is_A_fully_overlapping_B(first_elf, second_elf) or is_A_fully_overlapping_B(second_elf, first_elf)
